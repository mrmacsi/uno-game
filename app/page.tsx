...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center bg-gradient-to-br from-red-500 via-orange-500 to-yellow-400 dark:from-red-800 dark:via-orange-700 dark:to-yellow-600 p-2 sm:p-4">
      <motion.div 
        ...
        <div className="backdrop-blur-lg bg-white/80 dark:bg-gray-950/80 rounded-xl sm:rounded-2xl shadow-lg overflow-hidden flex flex-col border border-white/20 dark:border-gray-800/60">
          <div className="px-3 pt-3 pb-2 sm:px-4 sm:pt-4 sm:pb-3 border-b border-white/15 dark:border-gray-800/50">
            ...
            >
              ...
              <p className="mt-0.5 text-gray-500 dark:text-gray-400 text-[11px] sm:text-sm">
                ...
                <motion.div className="space-y-2.5 sm:space-y-3" variants={containerVariants}>
                  ...
                  <motion.div variants={itemVariants}>
                    <Link href="/join-room" className="w-full block">
                      <Button variant="outline" className="w-full py-2.5 sm:py-3 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900 flex items-center justify-center gap-1.5 text-sm sm:text-base text-gray-700 dark:text-gray-300 font-medium">
                  ...
                  <motion.div variants={itemVariants} className="relative py-1.5 sm:py-2">
                    ...
                    <div className="relative flex justify-center"><span className="bg-white/80 dark:bg-gray-950/80 px-2 text-xs text-gray-500 dark:text-gray-400">or</span></div>
                  </motion.div>
                  ...
                  <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 text-center px-1 pt-1">
          ...
          <div className="px-3 sm:px-4 py-2 text-center text-[10px] sm:text-xs text-gray-500 dark:text-gray-400/80 w-full mt-auto border-t border-gray-200/50 dark:border-gray-800/40 bg-white/50 dark:bg-gray-950/50">
